...
namespace edge {
	void UltraFaceEngine::img_overlay(cv::Mat& frame, const std::vector<DetectionCandidate>& ret, const int& width, const int& height)
	{
	...
	std::vector<DetectionCandidate> UltraFaceEngine::DetectWithOutputVector(
